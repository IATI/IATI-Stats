...
class ActivityStats(CommonSharedElements):
    ...
    def humanitarian(self):
        ...
        is_humanitarian_by_attrib = (self._version() in ['2.02']) and (is_humanitarian_by_attrib_activity or is_humanitarian_by_attrib_transaction)
        ...
        is_humanitarian_by_sector = is_humanitarian_by_sector_5_digit_activity or is_humanitarian_by_sector_3_digit_activity or ((is_humanitarian_by_sector_5_digit_transaction or is_humanitarian_by_sector_3_digit_transaction) and (self._major_version() in ['2']))
